...
## Project Structure
    ...
    ├── withered_limit_30881  # Django project configurations
...
1. Clone this repo and `cd withered_limit_30881`
...
2. Clone this repo and `cd withered_limit_30881`
